...
A Vinogradov-Korobov zero-free region for Dirchlet $L$-functions has been obtanied in
\cite{Khale*24}
...
\begin{thm}{Theorem (2024)}
  ...
  The Riemann $\zeta$-function has no zeros in the region
  $$
    \Re s\ge  1-\frac{1}{10.5\log q+61.5(\log |\Im s|)^{2/3}(\log\log |\Im s|)^{1/3}}
    \quad(|\Im s|\ge 10).
  $$
\end{thm}
...
\begin{flushright}\small\sl{}   Last updated on January 8th, 2024, by Olivier Ramar\'e
 \end{flushright}
