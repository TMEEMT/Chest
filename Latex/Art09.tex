...
\section{Interval with primes, without congruence condition, saving a constant}
...
The above theorem is improved in
\cite{Kadiri-Lumley*14}.
We find in particular the next result.

\begin{thm}{Theorem (2014)}

Let $x$ be a real number larger than $\exp(60)$. Then the interval
$$
\Bigl( x \Bigl(1-\frac1{1\,966\,196\,911}\Bigr),x \Bigr]
$$
contains at least one prime.
\end{thm}


This is further improved in
\cite{CullyHugill-Lee*24}.
We find in particular the next result.

\begin{thm}{Theorem (2024)}

Let $x$ be a real number larger than $\exp(60)$. Then the interval
$$
\Bigl( x \Bigl(1-\frac1{76\,900\,000\,000}\Bigr),x \Bigr]
$$
contains at least one prime.
\end{thm}


\section{Interval with primes, no congruence condition, saving more than a constant}
...
$$
\Bigl[ x, x \Bigl(1+\frac1{5000(\log x)^2}\Bigr) \Bigr]
$$
contains at least one prime.
\par 
...
\begin{flushright}\small\sl{}   Last updated on April 26th, 2024, by Olivier Ramar\'e.
 \end{flushright}
